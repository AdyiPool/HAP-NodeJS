...
/**
 * Characteristic "LightShow 3"
 */

Characteristic.LightShow3 = function() {
  Characteristic.call(this, 'Light Show 3', '9D254BAD-F125-4013-AD8D-57A6FBAE584C');
  this.setProps({
    format: Characteristic.Formats.UINT8,
    perms: [Characteristic.Perms.READ, Characteristic.Perms.WRITE, Characteristic.Perms.NOTIFY]
  });
...
inherits(Characteristic.LightShow3, Characteristic);

Characteristic.LightShow3.UUID = '9D254BAD-F125-4013-AD8D-57A6FBAE584C';

// The value property of LockTargetState must be one of the following:
Characteristic.LightShow3.SHOW1 = 0;
Characteristic.LightShow3.SHOW2 = 1;
...
Service.Lightbulb = function(displayName, subtype) {
  ...
  this.addOptionalCharacteristic(Characteristic.LightShow3);
