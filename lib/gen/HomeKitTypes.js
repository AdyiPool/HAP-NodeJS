...
/**
 * Characteristic "LightShow1"
 */

Characteristic.LightShow1 = function() {
  Characteristic.call(this, 'Light Show 1', '297D96DA-96ED-4FF9-9C6C-6EE8DBAA81C6');
  this.setProps({
    format: Characteristic.Formats.BOOL,
    perms: [Characteristic.Perms.READ, Characteristic.Perms.WRITE, Characteristic.Perms.NOTIFY]
  });
...
inherits(Characteristic.LightShow1, Characteristic);

Characteristic.LightShow1.UUID = '297D96DA-96ED-4FF9-9C6C-6EE8DBAA81C6';


/**
 * Characteristic "LightShow2"
 */

Characteristic.LightShow2 = function() {
  Characteristic.call(this, 'Light Show 2', 'DA6A292C-C1E9-465F-9ECF-CDED47591BAE');
  this.setProps({
    format: Characteristic.Formats.BOOL,
    perms: [Characteristic.Perms.READ, Characteristic.Perms.WRITE, Characteristic.Perms.NOTIFY]
  });
...
inherits(Characteristic.LightShow2, Characteristic);

Characteristic.LightShow2.UUID = 'DA6A292C-C1E9-465F-9ECF-CDED47591BAE';


/**
 * Characteristic "LightShowSpeed"
 */

Characteristic.LightShowSpeed = function() {
  Characteristic.call(this, 'LightShowSpeed', '146CBF55-3B06-4EC3-9A65-67A480EB5C19');
  this.setProps({
    format: Characteristic.Formats.INT,
    unit: Characteristic.Units.PERCENTAGE,
    maxValue: 100,
...
inherits(Characteristic.LightShowSpeed, Characteristic);

Characteristic.LightShowSpeed.UUID = '146CBF55-3B06-4EC3-9A65-67A480EB5C19';
...
Service.Lightbulb = function(displayName, subtype) {
  ...
  this.addOptionalCharacteristic(Characteristic.Name);
  this.addOptionalCharacteristic(Characteristic.LightShow1);
  this.addOptionalCharacteristic(Characteristic.LightShow2);
  this.addOptionalCharacteristic(Characteristic.LightShowSpeed);
