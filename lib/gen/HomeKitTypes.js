...
Characteristic.LightShow = function() {
  Characteristic.call(this, 'LightShow', '00002225-0000-1000-8000-0026BB765291');
  this.setProps({
    format: Characteristic.Formats.BOOL,
    perms: [Characteristic.Perms.READ, Characteristic.Perms.WRITE, Characteristic.Perms.NOTIFY]
  });
...
inherits(Characteristic.LightShow, Characteristic);

Characteristic.LightShow.UUID = '00002225-0000-1000-8000-0026BB765291';
...
Service.Lightbulb = function(displayName, subtype) {
  ...
  this.addOptionalCharacteristic(Characteristic.Name);
  this.addOptionalCharacteristic(Characteristic.LightShow);
